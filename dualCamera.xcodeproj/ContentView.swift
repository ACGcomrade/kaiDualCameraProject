...
struct ContentView: View {
    ...
    var body: some View {
        ZStack {
            // Full screen dual camera preview (back main, front PIP)
            DualCameraPreview(viewModel: viewModel)
                .ignoresSafeArea()
            
            // Zoom slider (on the left side)
            ...
            if viewModel.isRecording {
                VStack {
                    HStack {
                        ...
                        Text(timeString(from: viewModel.cameraManager.recordingDuration))
            ...
            VStack {
                ...
                // Captured images preview (if available)
